...
<section class="terms">
    <div>
        <input id="terms1" name="acc1" type="radio" checked />
        <label for="terms1">1 - Registrierung</label>
        <article class="termsText">
            1.1 Die Registrierung ist und bleibt vollkommen kostenlos.</p>
            1.2 Es d&uuml;rgen keine falschen Daten angeben werden. Ansonsten kommt es zu einer L&ouml;schung des Accounts.</p>
            1.3 Es darf nur sein eigenes Profil erstellt werden.</p>
            1.4 Es darf sich nur registriert werden, wenn noch keine Mitgliedschaft bei uns vorliegt.</p>
            1.5 Im Falle einer nicht vollst&auml;ndig abgeschlossenen Registrierung, versichern wir, dass wir die eingegebenen Daten nicht speichern.</p>
            1.6 Falls die zur Registration angegebenen Daten nicht durch die Betreiber als akzeptabel angesehen werden, liegt diesen das Recht vor, die Daten zu &auml;ndern.</p>
            1.7 Im Falle, dass Sie weder Student noch Lehrkraft/Professor sind, ist es Ihnen verboten, sich zu registrieren.<p /> 
            1. Eine Registration kann nur abgeschlossen werden, wenn diese Vertragsbedingungen akzeptiert werden.
        </article>
    </div>
    <div>
        <input id="terms2" name="acc1" type="radio" />
        <label for="terms2">2 - Pers&ouml;nliche Daten</label>
        <article class="termsText">
...
<h4>2. Pers&ouml;nliche Daten</h4>
2.1 Standardm&auml;&szlig;ig sind Vorname, Nachname, Klasse/Kurs und Bildungseinrichtung f&uuml;r jeden registrierten Benutzer sichtbar.</br>
2.2 Standardm&auml;&szlig;ig kann jeder aus derselben Klasse/Kurs die Uhrzeit und das Datum der letzten Aktivit&auml;t sehen.
</p>&nbsp;</p>
...
<h4>5. Hochladen eines Profilbildes</h4>
...
<h4>7. Cookies</h4>
7.1 Cookies werden genutzt, um Ihnen die Nutzung zu vereinfachen.
